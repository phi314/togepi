...
<html lang="en">
	...
	<body>
		...
		?>
				...
				<button type="button" class="btn btn-md btn-info" data-toggle="modal" data-target="#<?php echo $rs['id_proyek'];?>">
			...
			<table class="table table-striped">
				...
				<?php
					$sql = mysql_query("SELECT * FROM resiko where id_proyek='$rs[kode_proyek]' order by tinkat_kepentingan");
					$no = 1;
									...
									<div class="modal-content">
										...
										<div class="modal-body">
											<form method="POST" name="feditresiko" class="form-horizontal">
												<input type="hidden" name="id_resiko" value="<?php echo $isi['id_resiko'];?>" />												
												<div class="form-group">
													<label class="col-sm-2">Kode Proyek</label>
													<div class="col-sm-10">
