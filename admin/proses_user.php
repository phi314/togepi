<?php
    ...
    {
        header("location: {$site_url}admin/beranda.php?page=datauser.php&message=Nip: {$nip} sudah Ada");
    }
	else if (isset($_POST["submit"]))
	{
		...
		header("location:{$site_url}admin/beranda.php?page=datauser.php&message=Berhasil tambah user");
	}
?>
