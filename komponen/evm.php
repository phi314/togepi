...
<section>
    <h3>Chart SV</h3>
    <canvas id="graph-sv" height="100" width="300"></canvas>
</section>

<!-- Chart CV -->
<section>
    <h3>Chart CV</h3>
    <canvas id="graph-cv" height="100" width="300"></canvas>
</section>

<!-- Chart CV -->
<section>
    <h3>Kurva S</h3>
    <canvas id="graph-s" height="100" width="300"></canvas>
</section>

<!-- END Earned Value Management(EVM) -->
...
<script type="text/javascript">
        ...
        datasets : [
            {
                type: "line",
                label: "BCWS",
                fillColor : "rgba(220,220,2,0.2)",
                strokeColor : "rgba(220,220,220,1)",
                pointColor : "rgba(67,220,60,1)",
                pointStrokeColor : "#fff",
                pointHighlightFill : "#fff",
                pointHighlightStroke : "rgba(220,220,220,1)",
                data : [
                    <?php
                        echo implode(",", $array_bcws)
                    ?>
                ]
    ...
    window.onload = function(){
        var ctx_sv = document.getElementById("graph-sv").getContext("2d");
        var ctx_cv = document.getElementById("graph-cv").getContext("2d");
        var ctx_s = document.getElementById("graph-s").getContext("2d");

        window.myLine = new Chart(ctx_sv).Line(lineChartDataSV, {
            responsive: true
        });

        window.myLine = new Chart(ctx_cv).Line(lineChartDataCV, {
            responsive: true
        });

        window.myLine = new Chart(ctx_s).Line(lineChartDataS, {
            responsive: true,
            tooltipTemplate: "<%= 'Minggu ke-' + label %>",
