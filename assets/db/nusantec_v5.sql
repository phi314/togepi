...
--
-- Host: localhost
-- Generation Time: Aug 08, 2016 at 11:21 
...
INSERT INTO `proyek_pekerjaan_stakeholder` (`id`, `id_pekerjaan`, `id_stakeholder`, `raci`) VALUES
(1, 3, 31, 'i'),
(2, 3, 32, 'c'),
(3, 3, 33, 'a'),
(4, 3, 34, 'r'),
...
ALTER TABLE `proyek_pekerjaan_stakeholder`
 ADD PRIMARY KEY (`id`), ADD KEY `id_pekerjaan` (`id_pekerjaan`,`id_stakeholder`);
